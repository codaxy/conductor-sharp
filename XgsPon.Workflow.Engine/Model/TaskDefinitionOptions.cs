...
namespace XgsPon.Workflows.Engine.Model
{
    ...
    {
        public string OwnerApp { get; set; } = "Vodafone.Frinx.Workflows";
        public string CreatedBy { get; set; } = "vzfrinx@codaxy.com";
        public string UpdatedBy { get; set; } = "vzfrinx@codaxy.com";
        ...
        public string OwnerEmail { get; set; } = "vzfrinx@codaxy.com";
