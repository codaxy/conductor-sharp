...
namespace ConductorSharp.Client.Generated
{
    ...
    public partial class TaskDef
    {
        ...
        [Newtonsoft.Json.JsonProperty("pollTimeoutSeconds", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(0, int.MaxValue)]
        public int? PollTimeoutSeconds { get; set; }

        [Newtonsoft.Json.JsonProperty("backoffScaleFactor", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class WorkflowTask
    {
        ...
        [Newtonsoft.Json.JsonProperty("loopCondition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LoopCondition { get; set; }

        [Newtonsoft.Json.JsonProperty("loopOver", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<WorkflowTask> LoopOver { get; set; }

        [Newtonsoft.Json.JsonProperty("retryCount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? RetryCount { get; set; }

        [Newtonsoft.Json.JsonProperty("evaluatorType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("workflowTaskType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
    ...
    public partial class Task
    {
        ...
        [Newtonsoft.Json.JsonProperty("iteration", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Iteration { get; set; }

        [Newtonsoft.Json.JsonProperty("subWorkflowId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SubWorkflowId { get; set; }

        [Newtonsoft.Json.JsonProperty("subworkflowChanged", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("loopOverTask", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class Workflow
    {
        ...
        [Newtonsoft.Json.JsonProperty("lastRetriedTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? LastRetriedTime { get; set; }

        [Newtonsoft.Json.JsonProperty("failedTaskNames", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class WorkflowTestRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("taskRefToMockOutput", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("subWorkflowTestRequest", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class TaskResult
    {
        ...
        [Newtonsoft.Json.JsonProperty("extendLease", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
