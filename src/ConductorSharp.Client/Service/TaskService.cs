...
namespace ConductorSharp.Client.Service
{
    public class TaskService(ConductorClient client) : ITaskService
    {
        ...
        public async Task<SearchResultTaskSummary> SearchAsync(
            int? start = null,
            int? size = null,
            string? sort = null,
        ...
        public async Task<SearchResultTask> SearchV2Async(
            int? start = null,
            int? size = null,
            string? sort = null,
            string? freeText = null,
        ...
        public async Task<int> GetQueueAsync(
            string taskType,
            string? domain = null,
        ...
        public async Task<IDictionary<string, IDictionary<string, IDictionary<string, long>>>> ListQueuesVerboseAsync(
            CancellationToken cancellationToken = default
        ) => await _client.AllVerboseAsync(cancellationToken);

        public async Task<Generated.Task> PollAsync(
            string taskType,
            string? workerId,
            string? domain,
            CancellationToken cancellationToken = default
        ...
        public async Task<ICollection<Generated.Task>> BatchPollAsync(
            string taskType,
            string? workerId,
            string? domain,
            int? count = null,
        ...
        public async Task<ExternalStorageLocation> GetExternalStorageLocationAsync(
            string path,
            string operation,
            string payloadType,
            CancellationToken cancellationToken = default
