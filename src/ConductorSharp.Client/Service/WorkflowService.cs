...
namespace ConductorSharp.Client.Service
{
    public class WorkflowService(ConductorClient client) : IWorkflowService
    {
        ...
        /// </summary>
        public async Task SkipTaskAsync(string workflowId, string taskReferenceName, SkipTaskRequest skipTaskRequest, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        public async Task<string> RerunAsync(string workflowId, RerunWorkflowRequest rerunWorkflowRequest, CancellationToken cancellationToken = default)
            => await _client.RerunAsync(workflowId, rerunWorkflowRequest, cancellationToken);

        /// <summary>
        /// Lists workflows for the given correlation id list
        /// </summary>
        public async Task<IDictionary<string, ICollection<Workflow>>> GetCorrelatedAsync(string name, IEnumerable<string> correlationIds, bool? includeClosed = false, bool? includeTasks = false, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        public async Task<Workflow> GetExecutionStatusAsync(string workflowId, bool? includeTasks = false, CancellationToken cancellationToken = default)
        ...
        /// <returns></returns>
        public async Task<SearchResultWorkflowSummary> SearchAsync(int? start = null, int? size = null, string? sort = null, string? freeText = null, string? query = null, CancellationToken cancellationToken = default)
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<SearchResultWorkflow> SearchV2Async(int? start = null, int? size = null, string? sort = null, string? freeText = null, string? query = null, CancellationToken cancellationToken = default)
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<SearchResultWorkflowSummary> SearchByTasksAsync(int? start = null, int? size = null, string? sort = null, string? freeText = null, string? query = null, CancellationToken cancellationToken = default)
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<SearchResultWorkflow> SearchV2ByTasksAsync(int? start = null, int? size = null, string? sort = null, string? freeText = null, string? query = null, CancellationToken cancellationToken = default)
            => await _client.SearchWorkflowsByTasksV2Async(start, size, sort, freeText, query, cancellationToken);

        /// <summary>
        /// Retrieve all the running workflows
        /// </summary>
        public async Task<ICollection<string>> ListRunningAsync(string name, int? version, long? startTime = null, long? endTime = null, CancellationToken cancellationToken = default)
            => await _client.GetRunningWorkflowAsync(name, version, startTime, endTime, cancellationToken);

        /// <summary>
        /// Get the uri and path of the external storage where the workflow payload is to be stored
        /// </summary>
        public async Task GetExternalStorageLocationAsync(string path, string operation, string payloadType, CancellationToken cancellationToken = default)
