...
namespace ConductorSharp.Toolkit.Service
{
    public class ScaffoldingService : IScaffoldingService
    {
        ...
        public async Task<string> CreateWorkflowClass(WorkflowDefinition workflowDefinition)
        {
            ...
            var matches = namespaceRegex.Match(workflowDefinition.Name).Groups;
            ...
            name = SnakeCaseUtil.ToPascalCase($"{workflowDefinition.Name}_V{workflowDefinition.Version}").Trim();
            string note = null;
            ...
            var generatedNamespace = config.BaseNamespace + ".Workflows" + (!string.IsNullOrEmpty(naspace) ? $".{naspace}" : "");
