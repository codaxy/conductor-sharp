...
namespace ConductorSharp.Toolkit.Service
{
    public class ScaffoldingService : IScaffoldingService
    {
        ...
        public string CreateWorkflowClass(WorkflowDefinition workflowDefinition)
        {
            ...
            var modelGenerator = new TaskModelGenerator(_config.BaseNamespace + ".Tasks", name, TaskModelGenerator.ModelType.Workflow);
            ...
            //modelGenerator.OwnerApp = workflowDefinition.OwnerApp;
