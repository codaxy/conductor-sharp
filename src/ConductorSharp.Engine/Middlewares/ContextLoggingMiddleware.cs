...
public class ContextLoggingMiddleware<TRequest, TResponse> : INgWorkerMiddleware<TRequest, TResponse>
    where TRequest : class, ITaskInput<TResponse>, new()
{
    ...
    public ContextLoggingMiddleware(ConductorSharpExecutionContext executionContext)
    {
