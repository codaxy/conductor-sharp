...
namespace XgsPon.Workflows.Client.Util
{
    internal static class ApiUrls
    {
        ...
        public static Uri GetWorkflowStatus(string workflowId) =>
            "workflow/{0}?includeTasks=true".ToRelativeUri(workflowId);
        public static Uri GetWorkflowStatusWithoutTasks(string workflowId) =>
            "workflow/{0}?includeTasks=false".ToRelativeUri(workflowId);
